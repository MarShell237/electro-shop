...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Afficher la sidebar dès que la page est chargée
    sidebar.classList.add("active");

    // Ouvrir la sidebar en cliquant sur le logo
    ...
    // Fermer la sidebar en cliquant sur le bouton de fermeture
    ...
    categoryItems.forEach(item => {
        item.addEventListener("click", function () {
            ...
            sidebar.classList.remove("active"); // Fermer la sidebar après sélection
        });
    });
});
