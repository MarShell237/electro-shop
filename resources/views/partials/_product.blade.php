<div class="product-card" data-category="smartphones">
  ...
  {{-- <a href="https://wa.me/237695947432?text=Bonjour, je suis intéressé par le produit nom:{{ $product->name }} description:{{ $product->description }}" class="btn">Achetez maintenant</a> --}}
